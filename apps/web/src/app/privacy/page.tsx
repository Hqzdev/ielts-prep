...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy">
      ...
      <p>
        Veylo stores your account profile, study preferences, test attempts,
        answers, feedback, personal vocabulary and conversation transcripts to
        provide your learning history.
      </p>
