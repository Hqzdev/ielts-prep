  ...
  return (
    <div className="landing">
          ...
          <section className="landing-faq">
            ...
            <div className="landing-faq-list">
              ...
              <details>
                ...
                <p>
                  Manage your access in Profile. Veylo currently uses
                  invitation access; you can sign out or delete your account
      ...
      <footer className="landing-footer">
        <p>
          Veylo is an independent preparation platform and is not
          affiliated with, endorsed by or certified by IELTS. IELTS® is a
          registered trademark of the British Council, IDP Education and
          Cambridge University Press &amp; Assessment; the name is used here
          only to identify the exam.
        </p>
        <p>
        ...
        <p className="landing-reference-note">
          ...
          and guarantee copy are from GoPrep. They do not establish an Veylo partnership or refund offer.
        </p>
      </footer>
    </div>
  );
