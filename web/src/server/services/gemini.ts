...
import { criterionKeys, GradeValidator } from "@/domain/grade-validator";
import { AppError } from "@/domain/errors";
import type { Attempt } from "@/domain/attempt";
import { WavCodec } from "@/domain/wav";
import { wordFieldsSchema, wordInputSchema } from "@/domain/vocabulary";
import { conversationFeedbackSchema } from "@/domain/conversation-feedback";
import { personalityFor, type PreppyPreferences } from "@/domain/preppy";
...
export class GeminiProvider {
  ...
  constructor(
    ...
    if (!settings.key)
      throw new AppError("AI_UNAVAILABLE", "AI is not connected yet", 503);
