...
import {
  ...
  veyMotionFor,
} from "@/domain/vey-motion";
import {
  VeyMotionController,
  type VeyAnimationOptions,
} from "@/client/vey-motion-controller";
import { VeyGazeController } from "@/client/vey-gaze-controller";
import { VeyFaceModel, veyFaceFor } from "@/domain/vey-face";
